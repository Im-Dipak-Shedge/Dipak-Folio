  ...
  useEffect(() => {
    const fetchContributions = async () => {
      try {
        ...
        const url = "https://github-contributions-api.jogruber.de/v4/Im-Dipak-Shedge?y=last";
        ...
        try {
          ...
          const fallbackUrl = "https://github-contributions-api.jogruber.de/v4/Im-Dipak-Shedge";
  ...
  const getLevelColor = (level: number) => {
    switch (level) {
      case 0:
        return "#E8E3D8"; // empty
      case 1:
        return "#F4B4B8"; // light red
      case 2:
        return "#EF798A"; // medium
      case 3:
        return "#E63946"; // primary red
      case 4:
        return "#C1121F"; // deep red
      default:
        return "#E8E3D8";
    }
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
            ...
            <div className="overflow-x-auto">
              <div className="inline-grid grid-cols-[repeat(53,12px)] grid-rows-7 gap-[3px] min-w-max">
                {Array.from({ length: 53 * 7 }).map((_, i) => (
                  <div key={i} className="w-3 h-3" style={{ backgroundColor: "#E8E3D8" }} />
                ))}
              </div>
            </div>
          )}
          ...
          {error && (
            <div
              style={{ fontFamily: "var(--font-mono)" }}
              className="text-sm text-[#1A1A1A] text-center py-8"
            >
              ...
              return (
                <>
                    ...
                    <div style={{ minWidth: "max-content" }}>
                      ...
                      <div style={{ paddingLeft: DAY_LABEL_WIDTH, marginBottom: 4 }}>
                        <div style={{ position: "relative", height: 16, width: gridWidth }}>
                          {monthLabels
                            .reduce<{ labels: MonthLabel[]; lastX: number }>(
                              (acc, label) => {
                  ...
                  <div className="flex items-center justify-center gap-2 mt-6">
                    <span
                      style={{ fontFamily: "var(--font-mono)" }}
                      className="text-[11px] text-[#1A1A1A] opacity-60"
                    >
                      Less
                    </span>
                    {[0, 1, 2, 3, 4].map((level) => (
