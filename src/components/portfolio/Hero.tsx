      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-12">
          ...
          >
            ...
            <p style={{ fontFamily: "var(--font-mono)", fontWeight: 600 }} className="text-lg">
            ...
            >
              Building real-world projects, learning every day, and turning ideas into products.
              Currently seeking internship opportunities and exciting collaborations.
            </p>
            {/* CTA Buttons */}
            <motion.div
            ...
            >
              <motion.button
                ...
                className="px-8 py-4 bg-[#E63946] text-[#F5F0E8] border-[3px] border-[#1A1A1A] font-bold uppercase tracking-wider"
                whileHover={{
                  y: -2,
          ...
          >
            <div className="tag-chip-container relative h-[400px] lg:h-[500px]">
              {[
                { text: "#MERN", top: "8%", left: "55%", delay: 0 },
                { text: "#FullStack", top: "25%", left: "10%", delay: 0.15 },
                { text: "#ReactJS", top: "45%", left: "60%", delay: 0.3 },
                { text: "#Blockchain", top: "65%", left: "15%", delay: 0.45 },
